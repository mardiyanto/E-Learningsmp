...
<head>
    ...
    <title>Tambah Data Materi - E-Learning </title>
    <!-- General CSS Files -->
                                        ...
                                        <form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_materi') ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select required id="inputState" name="kelas" class="form-control">
                                                    ...
                                                    <option value="VII">VII ( Kelas Tujuh )</option>
                                                    <option value="VIII">VIII ( Kelas Delapan )</option>
                                                    <option value="IX">IX ( Kelas Sembilan )</option>
                                                </select>
                                            </div>
