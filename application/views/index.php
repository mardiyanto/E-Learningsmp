	...
	<div class="banner_inner d-flex align-items-center">
		...
		<div class="container">
			<div class="banner_content text-center">
				<h3 data-aos="fade-up" data-aos-duration="1600">Belajar Dimana Saja & Kapan Saja <br /> Mudah Dengan E-Learning</h3>
				<p data-aos="fade-up" data-aos-duration="1900">Dengan E-Learning kemudahan kegiatan belajar mengajar dapat terpenuhi. Para guru dan siswa dapat
					belajar meski banyak halangan atau rintangan. Nikmati Pembelajaran terstruktur dan efektif menggunakan E-Learning serta kemudahan belajar dengan menggunakan aplikasi kami. </p>
			...
			<div data-aos="fade-right" data-aos-duration="2200" class="col-lg-3 col-sm-6">
				<div class="finance_item">
					<div class="media">
						...
						<div class="media-body">
							<h5>Metode belajar mudah bisa di rumah</h5>
						</div>
					</div>
				</div>
			</div>
...
<!--================ Illustrations Area =================-->
<section class="E-Learning-for-indonesia p_20">
	<div class="container">
		<div class="row">
		...
		<div class="row">
			<div class="col-md-7 mx-auto">
				<div class="main_title">
					<h2 data-aos="fade-up" data-aos-duration="2000">E-Learning Dibuat Untuk Meningkatkan Kualitas Pembelajaran Di Smp Muhammadiyah 02 Sendang Agung</h2>
					<p data-aos="fade-up" data-aos-duration="2200">mari gunakan aplikasi ini untuk kemudahan dalam belajar siswa</p>
					</div>
			</div>
		</div>
	</div>
...
<section class="courses_area p_40">
	<div class="container">
		<div class="main_title">
			<h2 data-aos="fade-up" data-aos-duration="1600">Pelajaran Yang Tersedia di E-Learning</h2>
						...
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-user"></i>Guru Matematika SMP Muhammadiyah 02 Sendang Agung</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="courses_item" data-aos="fade-down" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru IPA SMP Muhammadiyah 02 Sendang Agung</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru English SMP Muhammadiyah 02 Sendang Agung</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="courses_item" data-aos="fade-up" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru Indonesia SMP Muhammadiyah 02 Sendang Agung</a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="course_item" data-aos="fade-left" data-aos-duration="1800">
					...
					<div class="hover_text">
						...
						<ul class="list">
							...
							<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
							<li><a href="#"><i class="lnr lnr-user"></i> Guru Agama SMP Muhammadiyah 02 Sendang Agung</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<section class="impress_area p_120">
	<div class="container">
		<div class="impress_inner text-center">
			...
			<p data-aos="fade-up" data-aos-duration="2000">Untuk memberikan materi pada siswa silahkan login dengan guru yang telah di sediakan oleh admin
			</p>
